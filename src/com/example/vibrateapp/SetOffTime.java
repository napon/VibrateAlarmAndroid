...
public class SetOffTime extends Activity {
	
	private int hour, minute;
	private static final int TIME_DIALOG_ID = 2222;
	private TextView output;
	private static Context context;
	private static final int REQUEST_CODE = 2;
	
	private SwitchBackOnBroadcastReceiver rAlarm;
	
	@Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_setofftime);
        output = (TextView) findViewById(R.id.output2);
        
        rAlarm = new SwitchBackOnBroadcastReceiver();
...
//	          Intent intent = new Intent(this, SwitchBackOnBroadcastReceiver.class);
//	          PendingIntent pendingIntent = PendingIntent.getBroadcast(this, REQUEST_CODE, intent, 0);
//	          alarmManager.set(AlarmManager.RTC, System.currentTimeMillis()+ 10000,pendingIntent);
	          
	          rAlarm.setAlarm(context, getAlarmTimeFromNow());
	    }
